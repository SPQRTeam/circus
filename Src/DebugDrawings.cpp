...
{
    if (!ptrDebugDrawingsScene) return;
...
void DebugDrawings::drawRegularGeom(mjtGeom type, const double size[3], const double pos[3], const float color[4])
{
    mjvGeom geom;
...
void DebugDrawings::drawRenderOnlyGeom(mjtGeom type, const double size[3], const double start[3], const double end[3], const double width, const float color[4])
{
    mjvGeom geom;
...
void DebugDrawings::drawSphere(int idLocal, const double center[3], const double radius, const float color[4])
{
...
void DebugDrawings::drawCircle(int idLocal, const double center[3], const double radius, const float color[4])
{
    if( !moveGeom(idLocal, center) )
    {
        double size[3] = { radius, 0.0, 0.0 };
...
void DebugDrawings::drawCylinder(int idLocal, const double center[3], double radius, double length, const float color[4])
{
    if( !moveGeom(idLocal, center) )
    {
...
void DebugDrawings::drawArrow(int idLocal, const double start[3], const double end[3],  const double thickness, const float color[4])
{
...
void DebugDrawings::drawLine(int idLocal, const double start[3], const double end[3],  const double thickness, const float color[4])
{
    if( !moveGeom(idLocal, start, end) )
    {
