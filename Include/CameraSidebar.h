...
public:
    ...
    void addRobotCameras(Robot* robot, const QString& robotName) {
        ...
        if (auto* t1 = dynamic_cast<T1*>(robot)) {
            auto* leftCam = new CameraDisplayWidget(
                t1->cameras[0], robotName + " - Left", this);
            auto* rightCam = new CameraDisplayWidget(
                t1->cameras[1], robotName + " - Right", this);
            ...
            auto* leftCam = new CameraDisplayWidget(
                k1->cameras[0], robotName + " - Left", this);
            auto* rightCam = new CameraDisplayWidget(
                k1->cameras[1], robotName + " - Right", this);
