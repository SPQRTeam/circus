...
class Camera : public Sensor {
    public:
        Camera(MujocoContext* mujContext, const char* cameraName) : Sensor(30.0f), mujContext(mujContext), mujModel(mujContext->model) {
        ...
        void doUpdate() override {
            ...
            if (!eglMakeCurrent(cameraContext.eglDisplay, cameraContext.eglSurface, cameraContext.eglSurface, cameraContext.eglContext)) {
    ...
    private:
        ...
        bool initializeCameraContext() {
            ...
            const EGLint configAttribs[] = {EGL_SURFACE_TYPE, EGL_PBUFFER_BIT, EGL_RENDERABLE_TYPE, EGL_OPENGL_BIT, EGL_RED_SIZE, 8, EGL_GREEN_SIZE, 8, EGL_BLUE_SIZE, 8, EGL_DEPTH_SIZE, 24, EGL_NONE};
            ...
            cameraContext.eglContext = eglCreateContext(cameraContext.eglDisplay, eglConfig, EGL_NO_CONTEXT, contextAttribs);
            ...
            cameraContext.eglSurface = eglCreatePbufferSurface(cameraContext.eglDisplay, eglConfig, pbufferAttribs);
        ...
        void cleanupCameraContext() {
            if (cameraContext.eglDisplay != EGL_NO_DISPLAY) {
                if (cameraContext.eglContext != EGL_NO_CONTEXT) {
                    eglMakeCurrent(cameraContext.eglDisplay, cameraContext.eglSurface, cameraContext.eglSurface, cameraContext.eglContext);
