...
export FASTDDS_DEFAULT_PROFILES_FILE=/app/booster_motion/fastdds_profile.xml
export BOOSTER_FASTRTPS_DEFAULT_PROFILES_FILE=/app/booster_motion/fastdds_profile.xml
